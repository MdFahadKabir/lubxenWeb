        ...
        <div className="flex flex-col lg:flex-row justify-between  px-4 sm:px-6 md:px-8 lg:px-10 xl:px-16">
          ...
          <div className="w-full md:w-1/5 mb-8 lg:mb-0 ">
                ...
                {categoryProducts.map((item, index) => (
                  ...
                  >
                    <motion.li
                      ...
                      className={` shadow-md  p-4 mb-2 mx-2 min-w-max transform duration-700 poppins-bold text-xs md:text-sm rounded-r-full leading-normal ${
                        product.slug === item.slug
                          ? "bg-[#BF1D2F] text-white text-lg"
                          : "hover:bg-[#BF1D2F] hover:text-white dark:bg-white dark:hover:bg-[#BF1D2F] text-lg"
                      }`}
                    >
                      {item.name}
                    </motion.li>
            ...
            <div className="hidden md:block">
              ...
              >
                <p className="poppins-bold text-lg sm:text-2xl md:text-2xl lg:text-2xl leading-normal pb-3 dark:text-white">
                  Contact
                </p>
                <div>
                  <div className="flex flex-row pb-3">
                    <FaMapLocationDot className="text-2xl text-[#BF1D2F] w-10" />
                    <p className="mulish-regular  text-sm leading-normal text-black dark:text-white pl-5 w-full text-justify">
                  ...
                  <div className="flex flex-row pb-3">
                    ...
                    <div>
                      {product.contact.contactNumber.map((contact, index) => (
                        <p
                          key={index}
                          className="mulish-regular  text-sm leading-normal text-black dark:text-white pl-5 w-full"
                        >
                  ...
                  <div className="flex flex-row pb-3">
                    ...
                    <p className="mulish-regular  text-sm leading-normal text-black dark:text-white pl-5 w-full">
          ...
          <div className="w-full md:w-4/5">
            <div className="flex flex-col md:flex-row md:justify-between">
              <div className="w-full my-auto">
                ...
                <motion.h2
                  ...
                  transition={{ duration: 0.5 }}
                  className="poppins-bold text-lg sm:text-2xl md:text-2xl lg:text-2xl leading-normal mb-2 dark:text-white"
                >
                  {product.name}
                </motion.h2>
                <motion.p
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5 }}
                  className="poppins-regular text-xs sm:text-sm md:text-sm lg:text-sm leading-normal mb-2 uppercase dark:text-white"
                >
                  ...
                  <div className="w-full">
                    ...
                    >
                      <motion.p
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5 }}
                        className="poppins-bold text-xs sm:text-sm md:text-sm lg:text-sm leading-normal mb-2 uppercase dark:text-white"
                      >
                        Highlight :
                      </motion.p>
                      {product.highlight.map((item, index) => (
                        <div key={index} className="flex flex-row">
                          ...
                          <p className="mulish-regular text-sm leading-normal text-black dark:text-white pl-2 text-justify">
                            {item.content}
                          </p>
                        </div>
                      ))}
            ...
            <motion.p
              ...
              className="mulish-regular  text-sm leading-normal text-black dark:text-white mb-3 text-justify"
            >
            ...
            <div className="flex flex-col md:flex-row md:justify-between">
              ...
              {/* Render industryApproval if available */}
              {product.industryApproval &&
                product.industryApproval.length > 0 && (
                  <div className="w-full">
                    <motion.div
                      initial={{ opacity: 0, x: -20 }}
                      animate={{ opacity: 1, x: 0 }}
                    ...
                    >
                      ...
                      {product.industryApproval.map((item, index) => (
                        <div key={index} className="flex flex-row">
                          <BsCircleHalf className="text-xs text-[#BF1D2F] mt-1" />
                          <p className="mulish-regular text-sm leading-normal text-black dark:text-white pl-2 text-justify">
                            {item.content}
              ...
              {/* Render application if available */}
