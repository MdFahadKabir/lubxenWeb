    ...
    <>
      <div>
        <div className="relative bg-[#101010]   md:rounded-tr-[150px]">
          ...
          <div className="flex flex-col md:flex-row md:justify-between text-white absolute -top-20 md:top-10 w-full px-4 sm:px-10 md:px-20 lg:px-30 xl:px-40">
            {/* Quote Form */}
          ...
          <div className="hidden md:block absolute bottom-10 md:bottom-10 w-full">
            <AnimatedNumber
